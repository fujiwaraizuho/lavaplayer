...
public class Ichiba {
    ...
    public String toString() {
        ...
        sb.append(Ichiba.class.getName()).append('@').append(Integer.toHexString(java.lang.System.identityHashCode(this))).append('[');
        sb.append("isEnabled");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof Ichiba)) {
            return false;
        }
        Ichiba rhs = ((Ichiba) other);

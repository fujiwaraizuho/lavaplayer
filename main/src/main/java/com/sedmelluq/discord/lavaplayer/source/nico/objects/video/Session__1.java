...
public class Session__1 {
    ...
    private AuthTypes__1 authTypes;
    ...
    private List<Object> transferPresets = null;
    @JsonProperty("urls")
    ...
    @JsonProperty("authTypes")
    public AuthTypes__1 getAuthTypes() {
        return authTypes;
    }

    @JsonProperty("authTypes")
    public void setAuthTypes(AuthTypes__1 authTypes) {
    ...
    @JsonProperty("transferPresets")
    public List<Object> getTransferPresets() {
        return transferPresets;
    }

    @JsonProperty("transferPresets")
    public void setTransferPresets(List<Object> transferPresets) {
    ...
    public String toString() {
        ...
        sb.append(Session__1 .class.getName()).append('@').append(Integer.toHexString(java.lang.System.identityHashCode(this))).append('[');
        sb.append("recipeId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof Session__1)) {
            return false;
        }
        Session__1 rhs = ((Session__1) other);
